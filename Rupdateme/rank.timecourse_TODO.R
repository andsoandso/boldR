...
rank.timecourse <- function(voxdf_stat, nulldist=FALSE) {

    # Collect data for each voxel (cond and roiname)
    # into a scalar, rank those scalars, the project the
    # ranks back onto the orginal data.
    # Return a voxdf_stat with a 'rank' column added.
...
# column 3.  Adds a col/factor for the ranksm returning
# the modified scores.
